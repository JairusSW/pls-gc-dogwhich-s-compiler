...
const zipping_1 = require("./scratch/zipping");
const loader_1 = require("./scratch/loader");
const newLocal = `
sprite main { 
    loc x;
    loc y;
...
`;
let parser = new parser_1.Parser(new tokenizer_1.Tokenizer(newLocal));
let tlv = parser.parseTopLevelStatement();
console.log(tlv.functions[1].statements);
loader_1.Project.targets[1] = (0, comp_1.Compile)(tlv);
//@ts-expect-error
